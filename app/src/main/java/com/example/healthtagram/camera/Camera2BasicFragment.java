...
package com.example.healthtagram.camera;
...
public class Camera2BasicFragment extends Fragment
    ...
    private int facingId = 0; //전면 화면
    private boolean mAutoFocusSupported; //자동포커스
    /**
    ...
    private static class ImageUploader implements Runnable {
        ...
        public void run() {
            ...
            final StorageReference imageRef = storageRef.child("images/" + user.getUid() + "/profile.jpg");
